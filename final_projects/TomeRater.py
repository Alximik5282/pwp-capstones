class User(object):
    def __init__(self, name, email):
        ...
        self.email = email
        self.books = {}
        self.representation = "User: {n}, email: {email}, books read: {number}"
    ...
    def change_email(self, address):
        self.email = address
        return "Email adress was changed!"

    def __repr__(self):
        return self.representation.format(n = self.name, email = self.email, number = len(self.books))
...
class Book(object):
    ...
    def set_isbn(self, isbn):
        self.isbn = isbn
        return "Book's ISBN has been update!"
...
class Fiction(Book):
    def __init__(self, title, author, isbn):
        ...
        self.author = author
        self.representation = "{t} by {a}"
        
    def get_author(self):
        return self.author
    
    def __repr__(self):
        return self.representation.format(t = self.title, a = self.author)
...
class Non_Fiction(Book):
    def __init__(self, title, subject, level, isbn):
        ...
        self.level = level
        self.representation = "{t}, a {l} on {s}"
    ...
    def __repr__(self):
        return self.representation.format(t = self.title, l = self.level, s = self.subject)
